Feature: Resources command
  ...
  Scenario: Show resources
    ...
    And I stub the following stack resources:
      | stack_name | logical_resource_id | physical_resource_id | resource_type | timestamp           | resource_status |
      | myapp-vpc  | Vpc                 | stack-vpc-123        | AWS::EC2::Vpc | 2015-11-02 06:41:58 | CREATE_COMPLETE |
