...
RSpec.describe StackMaster::SparkleFormation::CompileTime::MaxLengthValidator do
  ...
  describe '#validate' do
    ...
    scenarios = [
        {definition: {type: :string, max_length: 3}, parameter: 'abc', valid: true},
        {definition: {type: :string, max_length: 3}, parameter: 'abcd', valid: false, error: ['abcd']},
        {definition: {type: :string, max_length: 3, default: 'abc'}, parameter: nil, valid: true},
        {definition: {type: :string, max_length: 3, default: ['abc', 'xyz']}, parameter: nil, valid: true},
        {definition: {type: :string, max_length: 3, default: ['abcd', 'xyz']}, parameter: nil, valid: false, error: ['abcd']},
        {definition: {type: :string, max_length: 3, multiple:true, default: 'abc,xyz'}, parameter: nil, valid: true},
        {definition: {type: :string, max_length: 3, multiple:true, default: 'abcd,xyz'}, parameter: nil, valid: false, error: ['abcd']},
        {definition: {type: :string, max_length: 3, multiple:true, default: 'abc,,xyz'}, parameter: nil, valid: true},

        # {definition: {type: :number, max_length: 1}, parameter: 'abc', valid: true}
